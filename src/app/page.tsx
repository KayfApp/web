...
export default function Home() {
  return (
    ...
    <div className="flex items-center justify-start px-4 py-2 bg-white dark:bg-gray-800">
      <Link href="#" className="flex items-center gap-2" prefetch={false}>
        <MountainIcon className="h-6 w-6" />
        <span className="text-lg font-semibold">Kayf</span>
      </Link>
    </div>
    <div className="flex items-center justify-center px-4 py-2 bg-white dark:bg-gray-800">
